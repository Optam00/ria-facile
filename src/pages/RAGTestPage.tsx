...
const RAGTestPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Incrémenter le compteur avant d'ajouter à l'historique (même si ça échoue, on compte la tentative)
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-start bg-white py-12 rounded-3xl">
      ...
      <div className="w-full max-w-xs sm:max-w-2xl lg:max-w-4xl mt-6">
